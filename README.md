...
```mermaid
flowchart LR
    A["Ist-Landschaft verstehen"] --> B["Reifegrad bewerten"]
    B --> C["Zielarchitektur definieren"]
    C --> D["Use Cases priorisieren"]
    D --> E["Governance und Delivery-Modell aufsetzen"]
    E --> F["Pilotieren und skalieren"]
    F --> G["Ergebnisse messen und Portfolio nachsteuern"]
```
